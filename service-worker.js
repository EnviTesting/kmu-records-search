const CACHE_NAME = 'ema-register-list-first-20260626-v1';
const ASSETS = ['./','./index.html','./assets/styles.css','./assets/app.js','./data/documents.json','./documents.json','./manifest.webmanifest'];
